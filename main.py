...
def webhook():
    ...
    if data and "message" in data:
        ...
        if text in ["1", "١"]:
            send_to_telegram(chat_id, "مرحبًا بك ، أنا بوت الأكواد لمتجر شارك قيمينق 😀✋🏻\nاختر الخدمة:\n2 للحصول على كود ستيم\n3 للحصول على كود روكو ستار\n\nاضغط 8 للحصول على كود روكو ستار للعبة قراند 5")
        elif text in ["2", "٢"]:
        ...
        elif text in ["4", "٤", "5", "٥", "6", "٦", "7", "٧", "8", "٨"]:
            ...
            mapping = {
                ...
                "8": ("noreply@rockstargames.com", 1, "روكو ستار للعبة قراند 5"),
                "٨": ("noreply@rockstargames.com", 1, "روكو ستار للعبة قراند 5"),
            }
